...
class ACRegister extends StatefulWidget {
  @override
  _ACRegisterState createState() => _ACRegisterState();
}

class _ACRegisterState extends State<ACRegister> {
            ...
            children: <Widget>[
              Container(
                child: CircleAvatar(
                  ...
                  child:  Icon(MyFlutterApp.air_conditioner,),
                ),
              ),
            ],
          ),
